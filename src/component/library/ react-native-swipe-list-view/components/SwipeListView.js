  ...
  renderCell(VisibleComponent, HiddenComponent, key, item, shouldPreviewRow) {
    if (!HiddenComponent) {
      return React.cloneElement(VisibleComponent, {
        ...
        swipeGestureEnded: (_, data) => this.rowSwipeGestureEnded(key, data),
      });
    } else {
      return (
        <SwipeRow
          ...
          leftActivationValue={
            item.leftActivationValue || this.props.leftActivationValue
          }
          rightActivationValue={
            item.rightActivationValue || this.props.rightActivationValue
          }
          leftActionValue={
          ...
          initialLeftActionState={
            item.initialLeftActionState || this.props.initialLeftActionState
          }
          initialRightActionState={
            item.initialRightActionState || this.props.initialRightActionState
          }
          onLeftAction={() =>
            item.onLeftAction ||
